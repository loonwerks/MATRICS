...
include!("SchedState.rs");
include!("ScheduleChannels.rs");
include!("ScheduleTimeslices.rs");
include!("ScheduleUserPartitions.rs");
include!("Schedule.rs");
...
then xx would be imported in lib.rs via "use data::hamr::*"
*/
