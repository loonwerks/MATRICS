...
extern "C" {
  ...
  fn put_HMD_log(value: *mut Common::Log_Impl) -> bool;
...
pub fn unsafe_put_HMD_log(value: &Common::Log_Impl) -> bool
{
  unsafe {
    return put_HMD_log(value as *const Common::Log_Impl as *mut Common::Log_Impl);
  }
}
...
lazy_static::lazy_static! {
  ...
  pub static ref OUT_HMD_log: Mutex<Option<Common::Log_Impl>> = Mutex::new(None);
