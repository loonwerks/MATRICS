...
|:--|
|Implementation: [wifiDriver](../../GroundStation.aadl#L45)|
|Periodic |

|Thread: GroundStation::btDriver |
|:--|
|Implementation: [btDriver](../../GroundStation.aadl#L151)|
|Periodic |

|Thread: GroundStation::usbDriver |
|:--|
|Implementation: [usbDriver](../../GroundStation.aadl#L163)|
|Periodic |

|Thread: GroundStation::dataManager |
|:--|
|Implementation: [dataManager](../../GroundStation.aadl#L75)|
|Periodic |

|Thread: GroundStation::dataAnalysis |
|:--|
|Implementation: [dataAnalysis](../../GroundStation.aadl#L132)|
|Periodic |
...
|:--|
|Implementation: [firewall](../../Hardened_SW.aadl#L382)|
|Periodic |
...
- **APIs**
    ...
    <table>
    <tr><th>Port Name</th><th>Direction</th><th>Kind</th><th>Payload</th><th>Realizations</th></tr>
    <tr><td><a title='Model' href='../../GroundStation.aadl#L154'>btRecv</a></td>
        <td>In</td><td>Event Data</td>
    ...
    <tr><td><a title='Model' href='../../GroundStation.aadl#L155'>btSend</a></td>
        <td>Out</td><td>Event Data</td>
...
- **APIs**
    ...
    <table>
    <tr><th>Port Name</th><th>Direction</th><th>Kind</th><th>Payload</th><th>Realizations</th></tr>
    <tr><td><a title='Model' href='../../GroundStation.aadl#L166'>usbRecv</a></td>
        <td>In</td><td>Event Data</td>
    ...
    <tr><td><a title='Model' href='../../GroundStation.aadl#L167'>usbSend</a></td>
        <td>Out</td><td>Event Data</td>
...
- **APIs**
    ...
    <table>
    <tr><th>Port Name</th><th>Direction</th><th>Kind</th><th>Payload</th><th>Realizations</th></tr>
    <tr><td><a title='Model' href='../../GroundStation.aadl#L78'>HMD_log</a></td>
        <td>In</td><td>Event Data</td>
    ...
    <tr><td><a title='Model' href='../../GroundStation.aadl#L79'>request_log</a></td>
        <td>In</td><td>Event Data</td>
    ...
    <tr><td><a title='Model' href='../../GroundStation.aadl#L81'>zeroize</a></td>
    ...
    <tr><td><a title='Model' href='../../GroundStation.aadl#L80'>response_log</a></td>
        <td>Out</td><td>Event Data</td>
...
- **APIs**
    ...
    <table>
    <tr><th>Port Name</th><th>Direction</th><th>Kind</th><th>Payload</th><th>Realizations</th></tr>
    <tr><td><a title='Model' href='../../GroundStation.aadl#L136'>response_log</a></td>
        <td>In</td><td>Event Data</td>
    ...
    <tr><td><a title='Model' href='../../GroundStation.aadl#L138'>analysis_request</a></td>
        <td>In</td><td>Event Data</td>
    ...
    <tr><td><a title='Model' href='../../GroundStation.aadl#L135'>request_log</a></td>
        <td>Out</td><td>Event Data</td>
    ...
    <tr><td><a title='Model' href='../../GroundStation.aadl#L137'>analysis_report</a></td>
        <td>Out</td><td>Event Data</td>
...
- **APIs**
    ...
    <table>
    <tr><th>Port Name</th><th>Direction</th><th>Kind</th><th>Payload</th><th>Realizations</th></tr>
    <tr><td><a title='Model' href='../../Hardened_SW.aadl#L385'>analysis_request_in</a></td>
        <td>In</td><td>Event Data</td>
    ...
    <tr><td><a title='Model' href='../../Hardened_SW.aadl#L386'>analysis_request_out</a></td>
        <td>Out</td><td>Event Data</td>
