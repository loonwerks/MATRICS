...
|Thread: GroundStation::wifiGate |
|:--|
|Implementation: [wifiGate](../../GroundStation.aadl#L49)<br>
...
|:--|
|Implementation: [decryptor](../../Hardened_SW.aadl#L427)<br>
GUMBO: [Subclause](../../Hardened_SW.aadl#L442)|
|Periodic |

|Thread: Hardened_SW::encryptor |
|:--|
|Implementation: [encryptor](../../Hardened_SW.aadl#L473)<br>
GUMBO: [Subclause](../../Hardened_SW.aadl#L490)|
|Periodic |

|Thread: Hardened_SW::logMonitor |
|:--|
|Implementation: [logMonitor](../../Hardened_SW.aadl#L204)<br>
GUMBO: [Subclause](../../Hardened_SW.aadl#L240)|
|Periodic |

|Thread: Hardened_SW::reportMonitor |
|:--|
|Implementation: [reportMonitor](../../Hardened_SW.aadl#L302)<br>
GUMBO: [Subclause](../../Hardened_SW.aadl#L345)|
|Periodic |

|Thread: Hardened_SW::firewall |
|:--|
|Implementation: [firewall](../../Hardened_SW.aadl#L522)<br>
GUMBO: [Subclause](../../Hardened_SW.aadl#L539)|
|Periodic |
...
### Behavior Code
#### wifiGate: GroundStation::wifiGate

 - **Entry Points**


    Initialize: [Rust](crates/cpuSw_wifiGate_wifiGate/src/component/cpuSw_wifiGate_wifiGate_app.rs#L25)

    TimeTriggered: [Rust](crates/cpuSw_wifiGate_wifiGate/src/component/cpuSw_wifiGate_wifiGate_app.rs#L37)
...
- **APIs**
    ...
    <tr><td><a title='Model' href='../../GroundStation.aadl#L52'>wifiRecv</a></td>
        ...
        <td>Common::DummyMessage.Impl</td><td><a title='Memory Map: Lines 26-30' href='microkit.system#L26'>Memory Map</a> → <a title='C Shared Memory Variable: Line 12' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L12'>C var_addr</a> → <a title='C Interface: Lines 47-50' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L47'>C Interface</a> → <a title='C Extern: Line 14' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L14'>C Extern</a> → <a title='Rust/C Interface: Lines 22-32' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L22'>Rust/C Interface</a> → <a title='Unverified Rust Interface: Lines 38-45' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L38'>Unverified Rust Interface</a> → <a title='Rust/Verus API: Lines 127-138' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L127'>Rust/Verus API</a></td></tr>
    <tr><td><a title='Model' href='../../GroundStation.aadl#L55'>analysis_report</a></td>
        <td>In</td><td>Event Data</td>
        <td>Common::AnalysisReport.Impl</td><td><a title='Memory Map: Lines 31-35' href='microkit.system#L31'>Memory Map</a> → <a title='C Shared Memory Variable: Line 14' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L14'>C var_addr</a> → <a title='C Interface: Lines 60-63' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L60'>C Interface</a> → <a title='C Extern: Line 15' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L15'>C Extern</a> → <a title='Rust/C Interface: Lines 34-44' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L34'>Rust/C Interface</a> → <a title='Unverified Rust Interface: Lines 48-55' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L48'>Unverified Rust Interface</a> → <a title='Rust/Verus API: Lines 139-150' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L139'>Rust/Verus API</a></td></tr>
    <tr><td><a title='Model' href='../../GroundStation.aadl#L57'>alert</a></td>
        <td>In</td><td>Event Data</td>
        <td>Common::DummyMessage.Impl</td><td><a title='Memory Map: Lines 36-40' href='microkit.system#L36'>Memory Map</a> → <a title='C Shared Memory Variable: Line 16' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L16'>C var_addr</a> → <a title='C Interface: Lines 73-76' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L73'>C Interface</a> → <a title='C Extern: Line 16' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L16'>C Extern</a> → <a title='Rust/C Interface: Lines 46-56' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L46'>Rust/C Interface</a> → <a title='Unverified Rust Interface: Lines 58-65' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L58'>Unverified Rust Interface</a> → <a title='Rust/Verus API: Lines 151-162' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L151'>Rust/Verus API</a></td></tr>
    <tr><td><a title='Model' href='../../GroundStation.aadl#L53'>wifiSend</a></td>
        <td>Out</td><td>Event Data</td>
        <td>Common::DummyMessage.Impl</td><td><a title='Rust/Verus API: Lines 82-95' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L82'>Rust/Verus API</a> → <a title='Unverified Rust Interface: Lines 12-17' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L12'>Unverified Rust Interface</a> → <a title='Rust/C Interface: Lines 58-63' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L58'>Rust/C Interface</a> → <a title='C Extern: Line 17' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L17'>C Extern</a> → <a title='C Interface: Lines 21-25' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L21'>C Interface</a> → <a title='C Shared Memory Variable: Line 9' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L9'>C var_addr</a> → <a title='Memory Map: Lines 11-15' href='microkit.system#L11'>Memory Map</a></td></tr>
    <tr><td><a title='Model' href='../../GroundStation.aadl#L54'>HMD_log</a></td>
        <td>Out</td><td>Event Data</td>
        <td>Common::Log.Impl</td><td><a title='Rust/Verus API: Lines 96-109' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L96'>Rust/Verus API</a> → <a title='Unverified Rust Interface: Lines 20-25' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L20'>Unverified Rust Interface</a> → <a title='Rust/C Interface: Lines 65-70' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L65'>Rust/C Interface</a> → <a title='C Extern: Line 18' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L18'>C Extern</a> → <a title='C Interface: Lines 27-31' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L27'>C Interface</a> → <a title='C Shared Memory Variable: Line 10' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L10'>C var_addr</a> → <a title='Memory Map: Lines 16-20' href='microkit.system#L16'>Memory Map</a></td></tr>
    <tr><td><a title='Model' href='../../GroundStation.aadl#L56'>analysis_request</a></td>
        <td>Out</td><td>Event Data</td>
        <td>Common::AnalysisRequest.Impl</td><td><a title='Rust/Verus API: Lines 110-123' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L110'>Rust/Verus API</a> → <a title='Unverified Rust Interface: Lines 28-33' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_api.rs#L28'>Unverified Rust Interface</a> → <a title='Rust/C Interface: Lines 72-77' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L72'>Rust/C Interface</a> → <a title='C Extern: Line 19' href='crates/cpuSw_wifiGate_wifiGate/src/bridge/extern_c_api.rs#L19'>C Extern</a> → <a title='C Interface: Lines 33-37' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L33'>C Interface</a> → <a title='C Shared Memory Variable: Line 11' href='components/cpuSw_wifiGate_wifiGate/src/cpuSw_wifiGate_wifiGate.c#L11'>C var_addr</a> → <a title='Memory Map: Lines 21-25' href='microkit.system#L21'>Memory Map</a></td></tr>
    </table>
- **GUMBO**
    ...
    <td><a href=crates/cpuSw_wifiGate_wifiGate/src/component/cpuSw_wifiGate_wifiGate_app.rs#L11>Verus</a></td></tr></table>
    <table>
    <tr><th colspan=4>Initialize</th></tr>
    <tr><td>guarantee defaultAlert</td>
    <td><a href=../../GroundStation.aadl#L84>GUMBO</a></td>
    <td><a href=crates/cpuSw_wifiGate_wifiGate/src/component/cpuSw_wifiGate_wifiGate_app.rs#L30>Verus</a></td>
    <td><a href=crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_GUMBOX.rs#L22>GUMBOX</a></td>
    </tr></table>
    <table>
    <tr><th colspan=4>Compute</th></tr>
    <tr><td>guarantee alert_cmd_variable</td>
    <td><a href=../../GroundStation.aadl#L90>GUMBO</a></td>
    <td><a href=crates/cpuSw_wifiGate_wifiGate/src/component/cpuSw_wifiGate_wifiGate_app.rs#L50>Verus</a></td>
    <td><a href=crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_GUMBOX.rs#L67>GUMBOX</a></td>
    </tr>
    <tr><td>guarantee Process_Report</td>
    <td><a href=../../GroundStation.aadl#L93>GUMBO</a></td>
    <td><a href=crates/cpuSw_wifiGate_wifiGate/src/component/cpuSw_wifiGate_wifiGate_app.rs#L56>Verus</a></td>
    <td><a href=crates/cpuSw_wifiGate_wifiGate/src/bridge/cpuSw_wifiGate_wifiGate_GUMBOX.rs#L88>GUMBOX</a></td>
    </tr></table>
...
- **APIs**
    ...
    <tr><td><a title='Model' href='../../Hardened_SW.aadl#L20'>wifiRecvIn</a></td>
        <td>In</td><td>Event Data</td>
        <td>Common::DummyMessage.Impl</td><td><a title='Memory Map: Lines 69-73' href='microkit.system#L69'>Memory Map</a> → <a title='C Shared Memory Variable: Line 12' href='components/cpuSw_wifiDriver_wifiDriver/src/cpuSw_wifiDriver_wifiDriver.c#L12'>C var_addr</a> → <a title='C Interface: Lines 45-48' href='components/cpuSw_wifiDriver_wifiDriver/src/cpuSw_wifiDriver_wifiDriver.c#L45'>C Interface</a></td></tr>
    <tr><td><a title='Model' href='../../Hardened_SW.aadl#L22'>wifiSendIn</a></td>
        <td>In</td><td>Event Data</td>
        <td>Common::DummyMessage.Impl</td><td><a title='Memory Map: Lines 59-63' href='microkit.system#L59'>Memory Map</a> → <a title='C Shared Memory Variable: Line 9' href='components/cpuSw_wifiDriver_wifiDriver/src/cpuSw_wifiDriver_wifiDriver.c#L9'>C var_addr</a> → <a title='C Interface: Lines 26-29' href='components/cpuSw_wifiDriver_wifiDriver/src/cpuSw_wifiDriver_wifiDriver.c#L26'>C Interface</a></td></tr>
    <tr><td><a title='Model' href='../../Hardened_SW.aadl#L21'>wifiRecvOut</a></td>
        <td>Out</td><td>Event Data</td>
        <td>Common::DummyMessage.Impl</td><td><a title='C Interface: Lines 31-35' href='components/cpuSw_wifiDriver_wifiDriver/src/cpuSw_wifiDriver_wifiDriver.c#L31'>C Interface</a> → <a title='C Shared Memory Variable: Line 11' href='components/cpuSw_wifiDriver_wifiDriver/src/cpuSw_wifiDriver_wifiDriver.c#L11'>C var_addr</a> → <a title='Memory Map: Lines 64-68' href='microkit.system#L64'>Memory Map</a></td></tr>
    <tr><td><a title='Model' href='../../Hardened_SW.aadl#L23'>wifiSendOut</a></td>
        <td>Out</td><td>Event Data</td>
        <td>Common::DummyMessage.Impl</td><td><a title='C Interface: Lines 50-54' href='components/cpuSw_wifiDriver_wifiDriver/src/cpuSw_wifiDriver_wifiDriver.c#L50'>C Interface</a> → <a title='C Shared Memory Variable: Line 14' href='components/cpuSw_wifiDriver_wifiDriver/src/cpuSw_wifiDriver_wifiDriver.c#L14'>C var_addr</a> → <a title='Memory Map: Lines 74-78' href='microkit.system#L74'>Memory Map</a></td></tr>
    </table>
...
- **GUMBO**
    ...
    <td><a href=../../Hardened_SW.aadl#L444>GUMBO</a></td>
...
- **GUMBO**
    ...
    <td><a href=../../Hardened_SW.aadl#L494>GUMBO</a></td>
...
- **GUMBO**
    ...
    <tr><td>is_valid</td>
    <td><a href=../../Hardened_SW.aadl#L243>GUMBO</a></td>
    ...
    <td><a href=../../Hardened_SW.aadl#L262>GUMBO</a></td>
    ...
    <td><a href=../../Hardened_SW.aadl#L266>GUMBO</a></td>
...
- **GUMBO**
    ...
    <td><a href=../../Hardened_SW.aadl#L366>GUMBO</a></td>
    ...
    <tr><th colspan=4>Compute</th></tr>
    <tr><td>guarantee since_result_variable</td>
    <td><a href=../../Hardened_SW.aadl#L372>GUMBO</a></td>
    ...
    <td><a href=../../Hardened_SW.aadl#L375>GUMBO</a></td>
    ...
    <td><a href=../../Hardened_SW.aadl#L380>GUMBO</a></td>
    ...
    <td><a href=../../Hardened_SW.aadl#L383>GUMBO</a></td>
    ...
    <td><a href=../../Hardened_SW.aadl#L387>GUMBO</a></td>
    ...
    <td><a href=../../Hardened_SW.aadl#L391>GUMBO</a></td>
    ...
    <tr><th colspan=4>GUMBO Methods</th></tr>
    <tr><td>Counter</td>
    <td><a href=../../Hardened_SW.aadl#L352>GUMBO</a></td>
    ...
    <tr><td>ALLOW_LIST</td>
    <td><a href=../../Hardened_SW.aadl#L360>GUMBO</a></td>
...
- **GUMBO**
    ...
    <td><a href=../../Hardened_SW.aadl#L546>GUMBO</a></td>
    ...
    <tr><th colspan=4>GUMBO Methods</th></tr>
    <tr><td>ALLOW_LIST</td>
    <td><a href=../../Hardened_SW.aadl#L541>GUMBO</a></td>
