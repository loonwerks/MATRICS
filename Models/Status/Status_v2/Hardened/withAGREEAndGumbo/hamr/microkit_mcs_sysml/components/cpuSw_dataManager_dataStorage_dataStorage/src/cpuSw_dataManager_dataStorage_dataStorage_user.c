...
#include <cpuSw_dataManager_dataStorage_dataStorage_user.h>
...
uintptr_t GroundStation_Impl_Instance_cpuSw_dataManager_dataStorage_dataStorage_VM_Guest_RAM_vaddr;
...
void cpuSw_dataManager_dataStorage_dataStorage_initialize(void) {
  ...
  arch_guest_init_t guest_args = {
    ...
    .guest_ram_regions = { (struct guest_ram_region) {
      ...
      .size = GUEST_RAM_SIZE,
      .vmm_vaddr = (void *) GroundStation_Impl_Instance_cpuSw_dataManager_dataStorage_dataStorage_VM_Guest_RAM_vaddr } }
  };
  ...
  LOG_VMM("Guest started, leaving cpuSw_dataManager_dataStorage_dataStorage_initialize\n");
}

void cpuSw_dataManager_dataStorage_dataStorage_timeTriggered(void) {
  printf("%s: cpuSw_dataManager_dataStorage_dataStorage_timeTriggered invoked\n", microkit_name);
}

void cpuSw_dataManager_dataStorage_dataStorage_notify(microkit_channel ch) {
