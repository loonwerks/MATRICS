...
bool peek_wifiSendIn(Common_OutgoingWifiMessage_Impl *data) {
  sb_event_counter_t numDropped;
  return sb_queue_Common_OutgoingWifiMessage_Impl_1_peek((sb_queue_Common_OutgoingWifiMessage_Impl_1_Recv_t *) &wifiSendIn_recv_queue, &numDropped, data);
}

bool put_wifiRecvOut(const Common_IncomingWifiMessage_Impl *data) {
  sb_queue_Common_IncomingWifiMessage_Impl_1_enqueue((sb_queue_Common_IncomingWifiMessage_Impl_1_t *) wifiRecvOut_queue_1, (Common_IncomingWifiMessage_Impl *) data);

  return true;
}

bool peek_wifiRecvOut(Common_IncomingWifiMessage_Impl *data) {
  return sb_queue_Common_IncomingWifiMessage_Impl_1_peek_latest((sb_queue_Common_IncomingWifiMessage_Impl_1_t *) wifiRecvOut_queue_1, data);
}

bool wifiRecvIn_is_empty(void) {
  return sb_queue_Common_IncomingWifiMessage_Impl_1_is_empty(&wifiRecvIn_recv_queue);
}

bool get_wifiRecvIn_poll(sb_event_counter_t *numDropped, Common_IncomingWifiMessage_Impl *data) {
  return sb_queue_Common_IncomingWifiMessage_Impl_1_dequeue((sb_queue_Common_IncomingWifiMessage_Impl_1_Recv_t *) &wifiRecvIn_recv_queue, numDropped, data);
}
...
bool peek_wifiRecvIn(Common_IncomingWifiMessage_Impl *data) {
  sb_event_counter_t numDropped;
  return sb_queue_Common_IncomingWifiMessage_Impl_1_peek((sb_queue_Common_IncomingWifiMessage_Impl_1_Recv_t *) &wifiRecvIn_recv_queue, &numDropped, data);
}
...
bool peek_wifiSendOut(Common_OutgoingWifiMessage_Impl *data) {
  return sb_queue_Common_OutgoingWifiMessage_Impl_1_peek_latest((sb_queue_Common_OutgoingWifiMessage_Impl_1_t *) wifiSendOut_queue_1, data);
}
...
void notified(microkit_channel channel) {
  switch (channel) {
    case PORT_FROM_MON:
      cpuSw_wifiDriver_wifiDriverVM_wifiDriver_timeTriggered();
      break;
    default:
      cpuSw_wifiDriver_wifiDriverVM_wifiDriver_notify(channel);
  }
}
