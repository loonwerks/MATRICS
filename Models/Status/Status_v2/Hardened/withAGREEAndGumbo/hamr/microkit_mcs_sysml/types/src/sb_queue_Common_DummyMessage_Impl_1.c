...
bool sb_queue_Common_DummyMessage_Impl_1_peek_latest(
  sb_queue_Common_DummyMessage_Impl_1_t *queue,
  Common_DummyMessage_Impl *data) {
  ...
  sb_queue_Common_DummyMessage_Impl_1_Recv_t snapshot = {
    .numRecv = numSent - 1,
    .queue = queue
  };
  sb_event_counter_t numDropped;
  return sb_queue_Common_DummyMessage_Impl_1_dequeue(&snapshot, &numDropped, data);
}
...
bool sb_queue_Common_DummyMessage_Impl_1_peek(
  sb_queue_Common_DummyMessage_Impl_1_Recv_t *recvQueue,
  sb_event_counter_t *numDropped,
  Common_DummyMessage_Impl *data) {
  ...
  sb_queue_Common_DummyMessage_Impl_1_Recv_t snapshot = *recvQueue;
  return sb_queue_Common_DummyMessage_Impl_1_dequeue(&snapshot, numDropped, data);
}
