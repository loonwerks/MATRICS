...
bool sb_queue_uint8_t_1_peek_latest(
  sb_queue_uint8_t_1_t *queue,
  uint8_t *data) {
  ...
  sb_queue_uint8_t_1_Recv_t snapshot = {
    .numRecv = numSent - 1,
    .queue = queue
  };
  sb_event_counter_t numDropped;
  return sb_queue_uint8_t_1_dequeue(&snapshot, &numDropped, data);
}
...
bool sb_queue_uint8_t_1_peek(
  ...
  sb_queue_uint8_t_1_Recv_t snapshot = *recvQueue;
  return sb_queue_uint8_t_1_dequeue(&snapshot, numDropped, data);
}
