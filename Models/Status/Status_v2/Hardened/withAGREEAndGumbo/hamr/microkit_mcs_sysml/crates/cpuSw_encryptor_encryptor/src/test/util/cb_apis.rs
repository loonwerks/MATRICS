...
use crate::bridge::cpuSw_encryptor_encryptor_GUMBOX as GUMBOX;
...
/** Contract-based test harness for the compute entry point
  ...
  */
pub fn testComputeCB(api_analysis_report_in: Option<Common::AnalysisResponse_Impl>) -> HarnessResult
{
  // Initialize the app
  crate::cpuSw_encryptor_encryptor_initialize();
  ...
  if !GUMBOX::compute_CEP_Post(api_analysis_report_in, api_analysis_report_out) {
...
{
  return testComputeCB(container.api_analysis_report_in)
}
...
testComputeCB_macro {
  (
    ...
    proptest!{
      ...
      #[serial]
      fn $test_name(
        (api_analysis_report_in)
            in ($api_analysis_report_in_strat)
      ) {
        match$crate::test::util::cb_apis::testComputeCB(api_analysis_report_in) {
          $crate::test::util::cb_apis::HarnessResult::RejectedPrecondition => {
